...
const getRookPossibleMoves = (xAxisPos, yAxisPos, xAxisIndex, yAxisIndex) => {
    ...
    while (!topCollision || !bottomCollision || !rightCollision || !leftCollision) {
...
const isCheckmate = (enemyKingPosition) => {
    ...
    let myKingPossibleMoves = getKingPossibleMoves(xAxisPos, yAxisPos, xAxisIndex, yAxisIndex)
    ...
    if(myKingPossibleMoves.length === 0){
        return true
    }
